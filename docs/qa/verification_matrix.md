...
| Presentation and responsive layout | Collision, overflow, hierarchy; HTML/CSS changes | Change-specific, Human | Applicable | mobile shell and S-033 characterization | Required rendered viewport review | [S-033 validation](../validation/s033_mobile_presentation_accessibility_validation.md) |
