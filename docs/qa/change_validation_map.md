...
| Frontend/presentation | Rendered collision, overflow, lifecycle | Change-specific browser smoke, Human | Applicable | Normally mandatory | [S-038 browser baseline](../validation/archive/s038_minimal_browser_regression_baseline.md), [manual testing](../development/manual_testing.md) |
...
| Local archive ingestion | Unsafe container expansion, nondeterministic ordering, identity drift | Core, Change-specific security/compatibility, frozen evidence, Repository | Core | Only when rendered output is introduced | [Bounded EPUB ingestion](../features/epub_ingestion.md) |
| CI/workflows | Missing or misleading remote gate | Repository, affected gate, Change-specific | Workflow profile | Normally no; inspect actual remote evidence | Workflows, [testing](../development/testing.md), and [S-038A validation](../validation/archive/s038_parser_ci_evaluation_surface.md) |
