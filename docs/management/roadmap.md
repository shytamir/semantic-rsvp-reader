...
S-042 and S-043 remain `PROVISIONAL`, inactive, and unauthorized.
...
6. **S-041: Local Reading Continuity** — `READY_FOR_IMPLEMENTATION`; [scope](s041_local_reading_continuity.md); GitHub issue #16.
