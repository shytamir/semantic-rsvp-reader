...
1. **S-042: EPUB Ingestion and Long-Document Navigation**
   - State: S-042C `AWAITING_HUMAN_VALIDATION`
   - Owner: Human
...
7. **S-042: EPUB Ingestion and Long-Document Navigation** — S-042A and S-042B completed as `passed`; S-042C `AWAITING_HUMAN_VALIDATION`; [scope](s042_epub_long_document_navigation.md); open umbrella issue #17.
