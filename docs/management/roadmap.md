...
1. **S-042: EPUB Ingestion and Long-Document Navigation**
   - State: S-042A and S-042B `COMPLETED` as `passed`; no active scope.
   - Owner: none
...
Human decision D-010 authorizes program entry after the recorded S-036 `ready` disposition. S-037 through S-042B completed as `passed`; no scope is active:
