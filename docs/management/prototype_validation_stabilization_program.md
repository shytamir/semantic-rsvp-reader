...
8. **[S-035A: Development Environment Contract](s035a_development_environment_contract.md)** — scheduled; detailed authority is GitHub issue #21.
...
Only S-035 is active, and it awaits human validation. S-035A, S-035B, and S-036 remain scheduled, inactive, and must each be activated separately.
