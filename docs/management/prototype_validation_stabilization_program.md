...
4. **[S-032: Navigation and Interaction](s032_navigation_interaction.md)** — active at `AWAITING_HUMAN_VALIDATION`.
...
Only S-032 is active, with automated preparation complete and the human validation gate pending. S-033 through S-036 remain ordered management scopes and must be activated separately.
