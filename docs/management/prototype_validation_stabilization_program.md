...
8. **[S-035A: Development Environment Contract](s035a_development_environment_contract.md)** — active at `READY_FOR_IMPLEMENTATION`; detailed authority is GitHub issue #21.
...
Only S-035A is active and authorized for implementation. S-035B and S-036 remain scheduled, inactive, and must each be activated separately.
