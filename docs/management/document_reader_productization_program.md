...
4. **[S-039: Application-Service Boundary and Source-Document Contract](s039_application_service_source_document_contract.md)** — `AWAITING_HUMAN_VALIDATION`, owned by Human, and active; GitHub issue #2 tracks bounded implementation work S-039A.
