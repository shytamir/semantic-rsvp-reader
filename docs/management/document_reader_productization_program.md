...
The program is active under human authorization D-010, committed in `4baf3e8`, after S-036 completed with prototype disposition `ready`. S-037 through S-042B completed as `passed`. No scope is active; S-042C and S-043 remain provisional until separately activated.
...
7. **[S-042: EPUB Ingestion and Long-Document Navigation](s042_epub_long_document_navigation.md)** — split under open umbrella issue #17: S-042A and S-042B completed as `passed`; S-042C remains `PROVISIONAL`, inactive, and unauthorized.
...
- Only one scope may be active through [STATUS](STATUS.md); none is active. S-042C and S-043 remain provisional until separately activated. GitHub issue #24 is an authorized non-blocking follow-up and is not active.
