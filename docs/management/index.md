...
- S-032 is the sole active slice, with state `AWAITING_HUMAN_VALIDATION` and owner Human.
...
- S-033 through S-036 are scheduled only and are not authorized for implementation.
