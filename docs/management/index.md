...
- S-037 through S-042 and S-043A1 completed as `passed`. S-043 remains the current parent under open issue #18, with its Human rehearsal suspended. [S-043A2](s043a_epub_preparation_chain.md) is the sole active scope at `READY_FOR_IMPLEMENTATION`, owned by Codex under issue #28; S-043A3 remains provisional and inactive.
