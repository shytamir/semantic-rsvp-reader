...
- Root scope documents: [S-033](archive/s033_mobile_presentation_accessibility.md), [S-034](archive/s034_evidence_capture_reproducibility.md), [S-035](s035_service_surfaces_fallback.md), [S-035A](s035a_development_environment_contract.md), [S-035B](s035b_qa_authority_verification_framework.md), and [S-036](s036_end_to_end_prototype_readiness.md).
- S-037 is the sole active scope at `AWAITING_HUMAN_VALIDATION`, owned by Human, with GitHub issue #12 open as detailed authority. S-038 through S-043 remain provisional, inactive, and unauthorized.
...
- S-039 owns the application-service/source-document prerequisite and includes tracked work item S-039A, GitHub issue #2. D-008 separately governs backend-neutral linguistic evidence. Only S-037 is active; S-038 through S-043 remain provisional and unauthorized.
