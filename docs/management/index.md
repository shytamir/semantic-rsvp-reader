...
- S-031 is the sole active slice, with state `READY_FOR_IMPLEMENTATION` and owner Codex.
...
- S-032 through S-036 are scheduled only and are not authorized for implementation.
