...
- S-037 through S-042 and S-043A1 completed as `passed`. S-043 remains the current parent under open issue #18, with its Human rehearsal suspended. No scope is active; [S-043A2](s043a_epub_preparation_chain.md) remains provisional and awaits explicit activation under issue #28, followed by provisional S-043A3.
