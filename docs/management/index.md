...
- S-037 through S-040 completed as `passed`; S-040 is pinned to human-evidence commit `fb618d269f70f5497154f1309db84e69bf8f5451`. No scope is active. S-041 through S-043 remain provisional, inactive, and unauthorized.
...
- S-039 completed the application-service/source-document prerequisite, and S-040 completed bounded local ingestion through it. S-041 through S-043 remain provisional and unauthorized. GitHub issue #24 is an authorized non-blocking follow-up and is not active.
