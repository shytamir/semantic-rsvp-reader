...
- Active slice: S-034 Evidence Capture and Reproducibility (`AWAITING_HUMAN_VALIDATION`).
- Primary focus: validate private, complete, reviewable, and reproducible evidence capture across the shipped reader.
