...
- Active slice: S-028 Compact CI and Evidence Integrity (`READY_FOR_IMPLEMENTATION`).
- Primary focus: compact automation for supported prototype modes and management/evidence integrity.
