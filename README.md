...
- Active slice: S-030 Semantic Output and Structural Integrity (`READY_FOR_IMPLEMENTATION`).
- Primary focus: validate shipped parser-default semantic output, structural metadata, and mandatory rule-based fallback.
