...
- Active slice: S-035 Service Surfaces and Fallback (`AWAITING_HUMAN_VALIDATION`).
- Primary focus: validate Flask service contracts, parser-default operation, and mandatory dependency-light fallback.
