...
- Active scope: S-042B EPUB Reader Application Integration (`READY_FOR_IMPLEMENTATION`), owned by Codex.
- Primary focus: the bounded dedicated EPUB reader bridge. S-042C and S-043 remain inactive and unauthorized.
