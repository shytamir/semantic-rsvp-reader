...
- Active slice: S-032 Navigation and Interaction (`AWAITING_HUMAN_VALIDATION`).
- Primary focus: validate functional navigation and recovery behavior across the shipped reader.
